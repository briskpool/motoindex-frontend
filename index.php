...
<section class="race-sec pt-3 pt-lg-5 pb-4">
	<div class="overlay pt-3 pt-md-4">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h1>
				...
				<div class="col-6 col-md-8">
					<ul class="nav">
						<li class="nav-item d-none">
							<a href="#" class="nav-link px-2 px-md-3 px-lg-5 py-1">
								Upcoming Matches
							</a>
						</li>
						<li class="nav-item">
							<a href="#" class="nav-link px-2 px-md-3 px-lg-5 py-1 active">
								Standings
							</a>
						</li>
						<li class="nav-item d-none">
...
<section class="race-sec race-body py-4">
	<div class="overlay py-3">
		...
		<div class="row">
			<div class="col-12">
				<p class = "text-center">
					here i can't add anyting not design given table because you are using an image of table in your design 
					so may b  this table don't need to design . May b it's come to external link or src iframe ect..
				</p>
			</div>
		</div>
		</div>
